...
\begin{figure}[h]
    \includegraphics{images/generated/Q3_exposure_vs_log_irradiance_Red.png}
    \caption {Red Channel Exposure vs Log Irradiance}
\end{figure}
\begin{figure}[h]
    \includegraphics{images/generated/Q3_exposure_vs_log_irradiance_Green.png}
    \caption {Green Channel Exposure vs Log Irradiance}
\end{figure}

\begin{figure}[h]
    \includegraphics{images/generated/Q3_exposure_vs_log_irradiance_Blue.png}
...
\begin{figure}[h]
    \includegraphics{images/generated/Q4_generated_hdr.png}
...
\begin{figure}[h]
    \includegraphics{images/generated/Q5_tonemapped_image.png}
